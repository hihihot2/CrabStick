...
public class Foursquare {
	...
	public static final String EXPLORE_PARAMETER_LLACC = "llAcc";
	public static final String EXPLORE_PARAMETER_ALT = "alt";
	public static final String EXPLORE_PARAMETER_ALTACC = "altAcc";
	...
	public static final String EXPLORE_PARAMETER_FRIENDVISITS = "friendVisits";
	public static final String EXPLORE_PARAMETER_TIME = "time";
	public static final String EXPLORE_PARAMETER_DAY = "day";
	public static final String EXPLORE_PARAMETER_VENUEPHOTOS = "venuePhotos";
	public static final String EXPLORE_PARAMETER_LASTVENUE = "lastVenue";
	public static final String EXPLORE_PARAMETER_OPENNOW = "openNow";
	public static final String EXPLORE_PARAMETER_SORTBYDISTANCE = "sortByDistance";
